...
#include "snowcrash\src\Blueprint.h"
...
namespace snowcrashCLR {
	...
	{
	private:
		// TODO: vector<Resource^> ^resources;

	public:
		String ^name;
		String ^description;
		// TODO: resources (similar to resource groups in blueprint wrapper)

		/**
		 *	\brief	Wrap Snow Crash Resouce Group.
		...
		void wrap(const snowcrash::ResourceGroup& group)
		{
			...
			// TODO: Wrap Resources
			// Please take it from here the pattern is the same 
			// just follow previous BlueprintCLR and Snow Crash' Blueprint.h.
		}
	};
